export const DadosDoSistema = {
    urlPaginaDeLogin: 'http://sigeduca.seduc.mt.gov.br/geral/hwlogin2.aspx',
    urlSegundaPagina: 'http://sigeduca.seduc.mt.gov.br/geral/hwmsigeduca.aspx',
    ...
    urlLancarPresenca: 'http://sigeduca.seduc.mt.gov.br/ged/hwgedlancaravaliacao01.aspx?2,0,HWGedLancarAvaliacao.aspx%3f2%2c0',
    ...
    idConceito: 'TXTCONCEITO_0001',
    idInputBimestre:'vGEDMATDISCAVAREF',
    idSituacaoDaMatricula : 'span_vGGEDMATDISCSIT_0001',
    idAlunoEspecial : 'TXTALUNOESPECIAL_0001',
    idNumeroDeAlunos : 'span_vFCOUNTSDT',
    idAluno : 'span_vEGEDALUNOM_0001',
    idBtnProximoAluno : 'vFPROXIMO',
    idObservacoes : 'vGGEDMATDISCAVADESC_0001',
    idApoioPedagogico : 'vGGEDMATDISCAVAAPOIOPEDAGOGICO_0001',
    idBtnLancarAvaliacaoDiario:'vAVALIACAO_00', 
    ...
    nameBtnConsultar : 'BCONSULTAR',
    nameBtnIncluir : 'BINCLUIR',
    nameBtnAvancarDiario : 'BCONFIRMAR',    


    scriptSelecaoAnoLetivo: 'selecaoAnoLetivoEvento()'
}

export const DadosSistemaLancarConteudo = {
    urlLancarConteudo : 'http://sigeduca.seduc.mt.gov.br/ged/hwgedlancaravaliacao01.aspx?6,0,HWGedLancarAvaliacao.aspx%3f6%2c0',

    idInputData: 'vGGEDCONPROGDTA_00010001',
    idInputConteudo: 'vGGEDCONPROGDSC_00010002',


    nameBtnIncluirConteudo: 'BUTTONINCLUIR'
}